...
class CreateInvoiceTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice', function (Blueprint $table) {
            ...
            $table->integer('currency_id')->unsigned()->comment('Invoice currency reference.');
            $table->integer('doc_type_conf_id')->unsigned()->comment('Invoice document type configuration.');
            $table->integer('doc_type_conf_status_id')->unsigned()->comment('Invoice document type configuration status.');
            $table->integer('client_id')->unsigned()->comment('Invoice client.');
            $table->integer('user_id')->unsigned()->comment('Invoice user.');
            $table->timestamps();
            ...
            $table->foreign('doc_type_conf_status_id', 'invoice_doc_type_conf_status_fk')->references('id')->on('document_type_conf_status')->onDelete('no action')->onUpdate('no action');
        });
    }
